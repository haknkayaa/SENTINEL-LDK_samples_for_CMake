...
$LDK_LINUXENV --vcf:$LDK_VENDORCODE --fid:0 --dfp "$OUT_DIR/pyinst_work_dir/dist/$APP_NAME/libpython3.7m.so.1.0" "$OUT_DIR/pyinst_work_dir/dist/$APP_NAME/libpython3.7m.so.1.0"
