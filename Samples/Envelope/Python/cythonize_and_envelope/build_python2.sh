...
gcc -fPIC -pthread -fwrapv -O2 -Wall -fno-strict-aliasing -I$PYTHON2_INCLUDE_DIR -c moduleA.c
gcc -pthread -shared moduleA.o -o moduleA.so

#Build moduleB.pyx as a shared object (moduleB.so):
$CYTHON -2 --no-docstrings moduleB.pyx
gcc -fPIC -pthread -fwrapv -O2 -Wall -fno-strict-aliasing -I$PYTHON2_INCLUDE_DIR -c moduleB.c
