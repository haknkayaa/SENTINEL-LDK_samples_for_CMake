...
namespace netcore_test_sample
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\n\t              ---[ DotNet Core Runtime and Admin API Sample ]---\n");
            ...
            String hostname = "sntl_integrated_lm";
            long vendor_id = 37515;
            AdminApi adminApiIntegrated = new AdminApi(vendor_id, hostname);
            ...
            do
            {
                ...
                switch(num)
                {
                    ...
                    case 11:
                                ...
                                adminstatus = adminApiIntegrated.connect();
                                if (adminstatus != AdminStatus.StatusOk)
                                {
                                    Console.WriteLine("\n\t ADMIN CONNECT API failed with error status: {0}...", adminstatus);
                                    Console.ReadKey();
                                    System.Environment.Exit(1);
                                }
                    ...
                    case 12:
                                Console.Write("\n\t		 -------------------------------");
                                Console.WriteLine("\n\t		|***ADMIN GET KEY LIST FUNCTION***|");

                                adminstatus = adminApiIntegrated.adminGet(
                                    "<haspscope/>",
                                    "<admin><hasp><element name=\"*\" /></hasp></admin>",
                                    ref admindata
                                    );
                                if (adminstatus != AdminStatus.StatusOk)
                                {
                                    Console.WriteLine("\n\t ADMIN GET API failed with error status: {0}...", adminstatus);
                                    Console.ReadKey();
                                    System.Environment.Exit(1);
                                }
                                Console.WriteLine("\n\t Admin context fetched successfully...");
                                Console.WriteLine("\n Context Info: \n {0} \n", admindata);
                                break;
                    ...
                    case 13:
                                ...
                                adminstatus = adminApiIntegrated.adminSet(
                                    "<config>" +
                                    " <serveraddrs_clear/>" +
                                ...
                                if (adminstatus != AdminStatus.StatusOk)
                                {
                                    Console.WriteLine("\n\t ADMIN SET API failed with error status: {0}...", adminstatus);
                                    Console.ReadKey();
                                    System.Environment.Exit(1);
                                }
                                Console.WriteLine("\n\t ADMIN SET Info successfully...");
                                Console.WriteLine("\n Return Info: \n {0} \n", admindata);
                                break;
                    /* EXIT */
                    case 14:
